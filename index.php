...
<section class="content">
	...
	<article class="content__block">
		...
		<h2 class="content__head--large">Developer Tech Test</h2>
...
<section class="content">
	...
	<article class="content__media">
		<h2 class="content__head">This block has copy, an image and an optional button</h2>
		...
		<button type="button" class="content__button">Get in touch</button>
...
<section class="content">
	<article class="content__video">
		<h2 class="content__head">This block has copy and a video that plays inline</h2>
